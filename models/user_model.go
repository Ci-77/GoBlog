...
type User struct {
	MODEL
	UserName       string           `gorm:"size:36" json:"use_name"`                                                        //用户名
	...
	IP             string           `gorm:"size:20" json:"ip"`                                                              //权限，管理员，普通用户
	...
	CollectsModels []ArticleModel   `gorm:"many2many:user_collect;joinForeignKey:UserID;JoinReferences:ArticleID" json:"-"` //收藏的文章列表
